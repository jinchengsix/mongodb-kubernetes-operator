...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PVCChangedConfiguration) DeepCopyInto(out *PVCChangedConfiguration) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PVCChangedConfiguration.
func (in *PVCChangedConfiguration) DeepCopy() *PVCChangedConfiguration {
	if in == nil {
		return nil
	}
	out := new(PVCChangedConfiguration)
	in.DeepCopyInto(out)
	return out
}
